#pragma once
constexpr DWORD64 _s1 = __TIME__[6] - 48;
constexpr DWORD64 _s2 = __TIME__[7] - 48;
constexpr DWORD64 _h1 = __TIME__[0] - 48;
constexpr DWORD64 _h2 = __TIME__[1] - 48;
constexpr DWORD64 _m1 = __TIME__[3] - 48;
constexpr DWORD64 _m2 = __TIME__[4] - 48;
constexpr DWORD64 __tvtodw(DWORD64 high, DWORD64 low) { return high * 10 + low; }
constexpr DWORD64 _HOURS = __tvtodw(_h1, _h2) + 1;
constexpr DWORD64 _MINUTES = __tvtodw(_m1, _m2);
constexpr DWORD64 _SECONDS = __tvtodw(_s1, _s2);
constexpr DWORD64 _TIMEVAL = (_SECONDS + (_MINUTES * 60) + (_HOURS * 60 * 60));
bool tv5 = _HOURS % 5 == 5, tv2 = _MINUTES % 2 == 2, tv1 = _SECONDS % 2 == 1;
__int64 r0 = _HOURS + _HOURS / 2, r2 = _MINUTES * (_MINUTES - _HOURS), r1 = (_TIMEVAL ^ _h2) / _m1;
...
int s1key = 0xe1, s2key = 0x5b;
__declspec(noinline) static DWORD64 __UnhideDword0(volatile DWORD64 _param_value)
{
_catch:
...
__declspec(noinline) static DWORD64 __UnhideDword1(volatile DWORD64 _param_value)
{
